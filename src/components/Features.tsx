...
const features = [
  {
    ...
    desc: "Khả năng bắt sóng tốt, tự lấy sóng khi ra vào khu sóng yếu, hỗ trợ 4G/5G ổn định như máy Quốc Tế.",
    icon: <Wifi className="w-8 h-8" />,
    color: "bg-blue-500"
  },
  {
    title: "Fix Full Lỗi Máy Lock",
    desc: "Fix full lỗi máy lock: Tiktok Shop, Google Map xe máy, Điểm Truy Cập, Danh Bạ +84...",
    icon: <Settings className="w-8 h-8" />,
    color: "bg-primary"
  },
  {
    title: "Hỗ Trợ Mọi iOS",
    desc: "Từ iOS 15 đến iOS 26 mới nhất đều có thể kích hoạt mượt mà. Sim ghép không bị kén phiên bản iOS.",
    icon: <Smartphone className="w-8 h-8" />,
    color: "bg-purple-500"
  },
  {
    title: "Hỗ Trợ Miễn Phí",
    desc: "Sim ghép lắp đặt dễ dàng, có hỗ trợ nạp sẵn IMEI, hỗ trợ kích hoạt 24/7 online miễn phí nếu có vấn đề.",
